...
class CalloutReadNew():
    ...
    def _create_examples(file_path):
        ...
        for i,line in enumerate(open(file_path, 'r', encoding='utf-8', errors='ignore')):
            ...
            for cn in line["call_out"]:
                input = line["adtitle"]+"[SEP]"+line["desc1"]+"[SEP]"+line["desc2"]+"[SEP]"+line["lfcontent"]+line["url"]
                examples.append(InputExample(guid=str(i), article=input, summary=cn))
            if i>3000000:
                break
...
class CalloutReadv4(SummarizeProcessor):
    ...
    def _create_examples(file_path):
        ...
        for i,line in enumerate(open(file_path, 'r', encoding='utf-8', errors='ignore')):
            ...
            for cn in line["callout"]:
                examples.append(InputExample(guid=str(i), article=line["body"], summary=cn))
