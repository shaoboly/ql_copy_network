...
from noisy_generate.noise_generation import *

# noinspection PyAttributeOutsideInit
class BertS2LCopySepNoise(BaseModel):
    """
    ...
    def __init__(self, bert_config, batcher, hps):
        super(BertS2LCopySepNoise, self).__init__(hps, bert_config, batcher)
    ...
    def _build_summarization_model(self):
        ...
        #give noise
        encoder_output = guass_noisy(encoder_output,scale=0.2)
        #encoder_output = mask_prob(encoder_output,keep_prob=0.5)
