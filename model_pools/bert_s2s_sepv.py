...
class BertS2LSep(BaseModel):
    """
    Baseline, pre-trained bert as encoder + T-decoder(transformer).
    """

    def __init__(self, bert_config, batcher, hps):
        super(BertS2LSep, self).__init__(hps, bert_config, batcher)
    ...
    def _make_input_key(self):
        ...
        self.output_keys_train = ['loss', 'train_opt', 'summaries','pred_ids']
