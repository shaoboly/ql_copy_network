...
from utils.metric_utils import write_batch_for_rouge, rouge_eval, rouge_log,write_batch_beam_result_nq_pipeline
...
def inference(hps):
    ...
    while True:
        ...
        idx = write_batch_for_rouge(batch_summaries, decode_result, idx, ref_dir, res_dirs, trunc_dec_dir,
                                    hps, batch.true_num)
        print(idx)
        write_batch_beam_result_nq_pipeline(batch,decode_seq, hps)
